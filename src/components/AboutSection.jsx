      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center mb-32 md:mb-48">
          ...
          >
            ...
            <motion.h2
              variants={fadeInUp}
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif font-bold leading-tight text-slate-900 mb-10 tracking-tight"
            >
              Why photographers <br className="hidden sm:block" />
