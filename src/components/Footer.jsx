...
import { Instagram, Linkedin, Twitter, Facebook, Mail, ArrowRight, Phone, MessageCircle } from 'lucide-react';
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 pb-20 border-b border-slate-200">
          <motion.div variants={fadeInUp} className="lg:col-span-7">
            <Link to="/" className="text-xl font-black tracking-tighter mb-10 block group text-slate-900">
            ...
            <h3 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif font-bold leading-[1.1] tracking-tight text-slate-900">
              ...
              <span className="italic text-orange-600 font-light text-slate-400">visual standard?</span>
            </h3>
          </motion.div>
            ...
            <div className="max-w-md lg:ml-auto w-full">
              ...
              <form className="group relative flex items-center" onSubmit={(e) => e.preventDefault()}>
                <input 
                  ...
                  className="w-full bg-white px-6 py-5 rounded-[1.2rem] text-sm font-medium focus:outline-none placeholder:text-slate-400 border border-slate-200 shadow-sm focus:border-orange-600 transition-all duration-300 text-slate-900"
                />
        ...
        {/* --- MIDDLE SECTION (Side-by-Side Mobile Menu) --- */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 py-20 md:py-28">
          ...
          {/* CONTACT CARDS */}
          <motion.div variants={fadeInUp} className="col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="p-8 rounded-[2.2rem] bg-white border border-slate-200 hover:border-orange-600 transition-all group shadow-sm">
              <div className="w-10 h-10 bg-orange-50 rounded-xl flex items-center justify-center mb-5 group-hover:bg-orange-600 group-hover:text-white transition-colors duration-500 text-orange-600">
                <Mail className="w-5 h-5" />
              </div>
              <p className="text-[9px] font-black text-slate-400 uppercase mb-1 tracking-widest">Email Us</p>
              <p className="text-sm font-bold select-all text-slate-900 tracking-tight break-all">pixbrowni@gmail.com</p>
            </div>
            ...
            <div className="p-8 rounded-[2.2rem] bg-white border border-slate-200 hover:border-orange-600 transition-all group shadow-sm">
              ...
              <p className="text-sm font-bold text-slate-900 tracking-tight">+91 75024 73853</p>
            </div>
          </motion.div>
        </div>
        ...
        <motion.div variants={fadeInUp} className="pt-10 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-8 text-slate-400">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <p className="text-[10px] font-bold uppercase tracking-[0.2em] md:border-l md:border-slate-200 md:pl-8 text-center md:text-left">
              © 2026 Pixbrowni Studio <span className="hidden md:inline mx-2">|</span> <br className="md:hidden" /> All Rights Reserved
            </p>
          </div>
