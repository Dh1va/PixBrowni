...
export default function HDRBlending() {
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer}>
            ...
            >
              ...
              <span className="text-[9px] font-sans font-black uppercase tracking-[0.25em] text-slate-500 whitespace-nowrap">
                Services <span className="text-slate-300 mx-1">•</span> HDR Blending
              </span>
            </motion.div>
            ...
            <motion.p variants={fadeInUp} className="text-lg text-slate-600 max-w-xl leading-relaxed mb-10 font-medium">
              Combine multiple exposures into one perfectly balanced, realistic image. We recover bright highlights and reveal hidden shadow details without the fake HDR look.
            </motion.p>
          ...
          <motion.div initial="hidden" whileInView="visible" variants={imageReveal} viewport={{ once: true }} className="relative">
            <div className="relative rounded-[40px] overflow-hidden shadow-2xl border-[12px] border-white">
              <ReactCompareSlider
                itemOne={<ReactCompareSliderImage src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=1200" style={{ filter: "saturate(0.6) brightness(0.7) contrast(0.9)" }} alt="Unblended RAW" />}
                itemTwo={<ReactCompareSliderImage src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=1200" alt="Pixbrowni HDR Blend" />}
          ...
          <div className="grid lg:grid-cols-12 gap-16 lg:gap-24">
            ...
            <main className="lg:col-span-9 space-y-48">
              ...
              <motion.section initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeInUp} className="scroll-mt-32">
                <div className="w-full">
                  ...
                  <h2 className="text-4xl md:text-5xl font-serif font-bold mb-10 text-slate-900 leading-tight">
                    What is <span className="italic font-light text-orange-600">HDR Blending?</span>
                  </h2>
                  
                  <div className="space-y-6 mb-12">
                    <p className="text-lg md:text-xl text-slate-600 leading-relaxed font-medium">
                      HDR (High Dynamic Range) blending is the specialized process of merging multiple bracketed exposures into a single, perfectly balanced photograph. In real estate, capturing both the bright view through a window and the interior shadow details in one shot is technically impossible for a camera sensor alone.
                    </p>
                    <p className="text-lg md:text-xl text-slate-600 leading-relaxed font-medium">
                      Instead of using automated software that creates "halos" or unrealistic colors, our editors manually layer your exposures. We selectively blend the best parts of each frame to ensure natural color tones, crisp window pulls, and soft, even lighting that represents the property exactly as the human eye sees it.
                    </p>
                  </div>
                  ...
                  <motion.div variants={imageReveal} className="rounded-[2.5rem] overflow-hidden aspect-video shadow-2xl border-[8px] border-slate-50">
                    <img src="https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?q=80&w=1200" alt="HDR Interior" className="w-full h-full object-cover" />
                  </motion.div>
                </div>
              </motion.section>
              ...
              <motion.section initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="-mx-6 px-6">
                <div className="max-w-4xl mx-auto">
                  ...
                  <div className="grid md:grid-cols-2 gap-x-16 gap-y-20">
                    {[
                      { title: "Window Pulls", desc: "Expertly blending exterior views so they are perfectly visible through windows without overexposure.", icon: <Sun /> },
                      { title: "Shadow Recovery", desc: "Revealing deep architectural details in dark corners without introducing digital noise or artifacts.", icon: <Focus /> },
                      { title: "Natural Color Tones", desc: "Neutralizing yellow or blue color casts caused by mixed artificial and natural lighting sources.", icon: <Contrast /> },
                      { title: "Manual Masking", desc: "Precisely hand-masking light fixtures and furniture to prevent artificial halos and HDR 'glow'.", icon: <Layers /> },
                      { title: "Editorial Contrast", desc: "Professional tone mapping that adds depth and dimension while maintaining absolute realism.", icon: <ImageIcon /> },
                      { title: "White Balance Fix", desc: "Standardizing color temperatures across all bracketed frames for a cohesive final image.", icon: <Zap /> }
                    ].map((item, i) => (
              ...
              <motion.section initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="py-20 flex flex-col items-center text-center bg-[#FAF9F6] rounded-[3rem] border border-slate-100">
                 <h3 className="text-3xl md:text-6xl font-serif font-bold mb-8 text-slate-900 leading-tight max-w-3xl">Ready for Pixel-Perfect <br /><span className="italic font-light text-orange-600">Exposures?</span></h3>
                 <p className="text-slate-600 mb-12 max-w-2xl font-medium px-6">Join top-tier real estate photographers who rely on our 24-hour manual blending pipeline. boutique quality at global scale.</p>
