...
export default function ImageMasking() {
  ...
  // Related Services for the Creative/Vector Suite
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer}>
            ...
            >
              ...
              <span className="text-[9px] font-sans font-black uppercase tracking-[0.25em] text-slate-500 whitespace-nowrap">
                Services <span className="text-slate-300 mx-1">•</span> Image Masking
              </span>
            </motion.div>
            ...
            <motion.p variants={fadeInUp} className="text-lg text-slate-600 max-w-xl leading-relaxed mb-10 font-medium">
              Isolating the impossible. From fine hair strands to translucent glass, our masking services preserve the organic softness and transparency of your most complex subjects.
            </motion.p>
            ...
            <motion.div variants={fadeInUp} className="flex gap-12 mt-12 text-sm">
              ...
              <div><p className="text-2xl font-serif font-bold text-slate-900">High</p><p className="text-slate-600 font-bold uppercase text-[9px] tracking-widest">Complexity</p></div>
              <div><p className="text-2xl font-serif font-bold text-slate-900">Alpha</p><p className="text-slate-600 font-bold uppercase text-[9px] tracking-widest">Channel Support</p></div>
            </motion.div>
          </motion.div>
          ...
          >
            <div className="relative rounded-[40px] overflow-hidden shadow-2xl border-[12px] border-white">
              <ReactCompareSlider
                itemOne={<ReactCompareSliderImage src="https://images.unsplash.com/photo-1517423568366-8b83523034fd?q=80&w=1200" style={{ filter: "brightness(0.8)" }} alt="Original Complex Edge" />}
                itemTwo={<ReactCompareSliderImage src="https://images.unsplash.com/photo-1517423568366-8b83523034fd?q=80&w=1200" style={{ backgroundColor: '#F1F5F9' }} alt="Masked Subject" />}
            ...
            <main className="lg:col-span-9 space-y-48">
              ...
              >
                <div className="w-full">
                  <span className="text-orange-600 text-[10px] font-black uppercase tracking-[0.4em] mb-6 block">Technical Overview</span>
                  <h2 className="text-4xl md:text-5xl font-serif font-bold mb-10 text-slate-900 leading-tight">
                    What is <span className="italic font-light text-orange-600">Image Masking?</span>
                  </h2>
                  
                  <div className="space-y-6 mb-12">
                    <p className="text-lg md:text-xl text-slate-600 leading-relaxed font-medium">
                      Image masking is an advanced Photoshop technique used to isolate subjects with soft, fuzzy, or translucent edges that a standard vector clipping path cannot handle. While clipping paths are ideal for hard-edged products, masking is essential for capturing the micro-details of human hair, animal fur, smoke, and sheer fabrics.
                    </p>
                    <p className="text-lg md:text-xl text-slate-600 leading-relaxed font-medium">
                      At Pixbrowni, we utilize a combination of Channel Masking and manual Layer Masking to ensure that even the thinnest strands are preserved. This non-destructive workflow allows for flawless transparency control, enabling your subjects to be placed naturally onto any high-end commercial or editorial background without "halo" effects or jagged borders.
                    </p>
                  </div>
                  ...
                  >
                    <img src="https://images.unsplash.com/photo-1521119989659-a83eee4882c2?q=80&w=1200" alt="Model Hair Masking" className="w-full h-full object-cover" />
                  </motion.div>
                </div>
              </motion.section>
                ...
                <div className="max-w-4xl mx-auto">
                  <motion.div variants={fadeInUp} className="mb-20">
                    ...
                    <h2 className="text-3xl md:text-5xl font-serif font-bold text-slate-900 leading-tight">
                      The Pixbrowni <br />
                      <span className="italic font-light text-orange-600"> Masking Standard</span>
                    </h2>
                  </motion.div>
                  <div className="grid md:grid-cols-2 gap-x-16 gap-y-20">
                    {[
                      { title: "Fine Hair Isolation", desc: "Capturing individual strands of human hair or pet fur while maintaining soft, natural transitions against any background.", icon: <Smile /> },
                      { title: "Transparency Control", desc: "Retaining the translucent properties of glass bottles, sheer fabrics, and liquid splashes for high-end beverage and fashion ads.", icon: <Layers /> },
                      { title: "Channel Masking Mastery", desc: "Advanced technical selection based on color channels to isolate complex objects like winter trees or mesh surfaces.", icon: <Wand2 /> },
                      { title: "Alpha Channel Delivery", desc: "Saving masks within Alpha Channels in your PSD files, providing your design team with total control over transparency.", icon: <Maximize /> },
                      { title: "Refine Edge Precision", desc: "Manual cleanup of edge 'spill' and color contamination to ensure the subject blends perfectly into new environments.", icon: <Wind /> },
                      { title: "High-Volume Production", desc: "Scalable workflows capable of processing large-scale fashion lookbooks and catalogs with a 24-hour turnaround.", icon: <PackageCheck /> }
                    ].map((item, i) => (
              ...
              >
                 <h3 className="text-3xl md:text-6xl font-serif font-bold mb-8 text-slate-900 leading-tight max-w-3xl">Flawless Edges. <br /><span className="italic font-light text-orange-600">Total Transparency.</span></h3>
                 <p className="text-slate-600 mb-12 max-w-2xl font-medium px-6">Join high-fashion brands and beverage companies who rely on our advanced masking pipeline for their complex isolation needs.</p>
