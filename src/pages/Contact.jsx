  ...
  return (
    <div className="bg-white text-slate-900 min-h-screen pt-36 md:pt-48 pb-32">
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* --- HEADER --- */}
        <div className="mb-24">
          <motion.span initial="hidden" animate="visible" variants={fadeInUp} className="text-orange-600 text-[11px] font-bold uppercase tracking-widest mb-4 block">Direct Channel</motion.span>
        ...
        <div className="grid lg:grid-cols-12 gap-20">
          ...
          <div className="lg:col-span-4 space-y-16">
            ...
            <div className="p-10 bg-slate-50 rounded-[40px] border border-slate-100 relative overflow-hidden">
               ...
               <h4 className="text-sm font-bold mb-3 uppercase text-slate-900">Enterprise Security</h4>
               <p className="text-sm text-slate-600 leading-relaxed">Your raw data and commercial intellectual property are protected by strict NDA protocols and 256-bit encryption.</p>
            </div>
          </div>
                ...
                {status !== 'success' ? (
                  <motion.form key="form" onSubmit={handleSubmit} initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="space-y-12">
                    ...
                    <div className="grid md:grid-cols-2 gap-12">
                      ...
                      <div className="group relative border-b border-slate-200 focus-within:border-slate-900 transition-colors pb-4">
                        <label className="text-[10px] font-bold uppercase tracking-widest text-slate-400 block mb-2 transition-colors group-focus-within:text-slate-900">Agency Name</label>
                        <input name="company" type="text" placeholder="Studio / Firm" className="w-full bg-transparent outline-none font-medium text-lg text-slate-900 placeholder:text-slate-600" />
                      </div>
                    </div>

                    <div className="grid md:grid-cols-2 gap-12">
                      <div className="group relative border-b border-slate-200 focus-within:border-slate-900 transition-colors pb-4">
                        <label className="text-[10px] font-bold uppercase tracking-widest text-slate-400 block mb-2 transition-colors group-focus-within:text-slate-900">Work Email</label>
                      ...
                      <div className="group relative border-b border-slate-200 focus-within:border-slate-900 transition-colors pb-4">
                        <label className="text-[10px] font-bold uppercase tracking-widest text-slate-400 block mb-2 transition-colors group-focus-within:text-slate-900">Specialization</label>
                    ...
                    <div className="group relative border-b border-slate-200 focus-within:border-slate-900 transition-colors pb-4">
                      <label className="text-[10px] font-bold uppercase tracking-widest text-slate-400 block mb-2 transition-colors group-focus-within:text-slate-900">Monthly Asset Volume</label>
                      <div className="relative">
                        <select name="volume" className="w-full bg-transparent outline-none font-medium text-lg appearance-none cursor-pointer text-slate-900">
                    ...
                    <div className="group relative border-b border-slate-200 focus-within:border-slate-900 transition-colors pb-4">
                      <label className="text-[10px] font-bold uppercase tracking-widest text-slate-400 block mb-2 transition-colors group-focus-within:text-slate-900">Project Brief / File Link</label>
                      <textarea name="message" required rows="2" placeholder="Detail your requirements or share a link..." className="w-full bg-transparent outline-none font-medium text-lg resize-none text-slate-900 placeholder:text-slate-600" />
                    </div>

                    <div className="pt-6">
                      <button type="submit" disabled={status !== 'idle'} className="w-full md:w-auto px-14 py-5 bg-slate-900 text-white rounded-2xl font-bold uppercase tracking-widest text-[10px] flex items-center justify-center gap-3 hover:bg-orange-600 transition-all shadow-xl disabled:opacity-50 group">
                  ...
                  <motion.div initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} className="text-center py-20 bg-slate-50 rounded-[40px] border border-slate-100">
                    ...
                    <p className="text-slate-600 font-medium mb-10 max-w-sm mx-auto leading-relaxed text-base px-6">
                      Our production lead is reviewing your requirements. Expect a response within 4 hours.
                    </p>
                    <button onClick={() => setStatus('idle')} className="text-[10px] font-bold uppercase tracking-widest text-orange-600 border-b-2 border-orange-600 pb-1 hover:text-slate-900 hover:border-slate-900 transition-all">Submit another brief</button>
                  </motion.div>
                )}
              </AnimatePresence>
            </div>
